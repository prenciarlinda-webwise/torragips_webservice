    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: t('title'), url: `/${locale}/kontakt/` },
        ]}
      />
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-primary">{t('info.email')}</h3>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-primary">{t('info.address')}</h3>
