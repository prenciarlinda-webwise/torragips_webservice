  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        'x-default': '/en/wall-plastering-tirana/',
      },
    },
    openGraph: {
      title: locale === 'sq'
...
export default async function PlasteringTiranaPage({ params }: Props) {
  ...
  const commercialCategories = isAlbanian ? [
    { icon: 'office' as const, title: 'Kulla Rezidenciale' },
    { icon: 'hotel' as const, title: 'Apartamente & Vila' },
    { icon: 'shopping' as const, title: 'Zyra Biznesi' },
    { icon: 'airport' as const, title: 'Restorante & Dyqane' },
  ] : [
    { icon: 'office' as const, title: 'Residential Towers' },
    { icon: 'hotel' as const, title: 'Apartments & Villas' },
    { icon: 'shopping' as const, title: 'Business Offices' },
    { icon: 'airport' as const, title: 'Restaurants & Shops' },
  ];

  const benefits = isAlbanian ? [
    { title: 'Njohje e Ndërtesave të Tiranës', description: 'Dimë specifikat e pallateve të vjetra dhe kullave moderne të kryeqytetit.' },
    { title: 'Suva për Klimën Kontinentale', description: 'Materiale të zgjedhura për verërat e nxehta dhe dimrat e lagësht të Tiranës.' },
    { title: 'Ekip Lokal në Tiranë', description: 'Mjeshtrat tanë janë në Tiranë - arrijmë shpejt pa kosto shtesë.' },
    { title: 'Punojmë pa Ndërprerje', description: 'Patinim jashtë orarit për zyra, dyqane dhe restorante aktive.' },
    { title: 'Nga Apartamenti te Kulla', description: 'Trajtojmë çdo madhësi - nga rinovimi i banjës te fasada e pallatit.' },
    { title: 'Vizitë Falas në Tiranë', description: 'Inspektim dhe ofertë brenda ditës në çdo zonë të kryeqytetit.' },
  ] : [
    { title: 'Tirana Building Knowledge', description: 'We know the specifics of old apartment blocks and modern towers in the capital.' },
    { title: 'Plaster for Continental Climate', description: 'Materials selected for Tirana\'s hot summers and humid winters.' },
    { title: 'Local Team in Tirana', description: 'Our craftsmen are in Tirana - we arrive quickly with no extra costs.' },
    { title: 'No Disruption Work', description: 'Plastering outside hours for active offices, shops and restaurants.' },
    { title: 'From Apartment to Tower', description: 'We handle every size - from bathroom renovation to building facade.' },
    { title: 'Free Visit in Tirana', description: 'Same-day inspection and quote in any area of the capital.' },
  ];

  const processSteps = isAlbanian ? [
    { step: '1', title: 'Vizitë në Tiranë', description: 'Inspektim falas i mureve' },
    { step: '2', title: 'Diagnozë Murash', description: 'Vlerësim i gjendjes dhe lagështisë' },
    { step: '3', title: 'Zgjedhje Suvaje', description: 'Gips, çimento ose dekorative' },
    { step: '4', title: 'Patinim Profesional', description: 'Aplikim sipas standardeve' },
    { step: '5', title: 'Kontroll & Garanci', description: 'Sipërfaqe perfekte e garantuar' },
  ] : [
    { step: '1', title: 'Tirana Visit', description: 'Free wall inspection' },
    { step: '2', title: 'Wall Diagnosis', description: 'Condition and moisture assessment' },
    { step: '3', title: 'Plaster Selection', description: 'Gypsum, cement or decorative' },
    { step: '4', title: 'Professional Plastering', description: 'Standards-compliant application' },
    { step: '5', title: 'Check & Warranty', description: 'Guaranteed perfect surfaces' },
  ];
  ...
  const pageData = isAlbanian ? {
    ...
    serviceFeatures: [
      {
        ...
        title: 'Patinim për Apartamente Tiranëse',
        description: 'Sipërfaqe të lëmuara për apartamentet e reja dhe rinovimet në Bllok, Komunë dhe Kashar. Bazë perfekte për lyerje cilësore.',
        features: ['Apartamente të reja', 'Rinovime në qendër', 'Bazë për lyerje', 'Sipërfaqe ultra-lëmuara'],
      },
      {
        icon: 'partition' as const,
        title: 'Fasada Pallatesh në Tiranë',
        description: 'Patinim jashtëm për kullat e reja dhe pallatet ekzistuese. Suva izoluese termike për kursim energjie në klimën e Tiranës.',
        features: ['Kulla moderne', 'Izolim termik', 'Rezistencë pluhuri', 'Pallate ekzistuese'],
      },
      {
        icon: 'decoration' as const,
        title: 'Suva Dekorative për Biznese',
        description: 'Efekte stucco veneziano dhe travertini për lobby zyrtare, restorante në Bllok dhe hotele në qendër të Tiranës.',
        features: ['Lobby zyrtare', 'Restorante Blloku', 'Stucco veneziano', 'Stil urban modern'],
      },
      {
        icon: 'insulation' as const,
        title: 'Rinovime Muraturash Urbane',
        description: 'Riparime çarjesh dhe dëmtimesh lagështie në pallate dhe ndërtesa të vjetra të Tiranës. Restaurim pa ndërhyrje strukturore.',
        features: ['Pallate të vjetra', 'Çarje lagështie', 'Restaurim fasadash', 'Rinovim i plotë'],
      },
    ],
    ...
    serviceFeatures: [
      {
        icon: 'ceiling' as const,
        title: 'Plastering for Tirana Apartments',
        description: 'Smooth surfaces for new apartments and renovations in Blloku, Komuna and Kashar. Perfect base for quality painting.',
        features: ['New apartments', 'Center renovations', 'Paint base', 'Ultra-smooth surfaces'],
      },
      {
        icon: 'partition' as const,
        title: 'Tirana Building Facades',
        description: 'Exterior plastering for new towers and existing buildings. Thermal insulation plaster for energy savings in Tirana\'s climate.',
        features: ['Modern towers', 'Thermal insulation', 'Dust resistance', 'Existing buildings'],
      },
      {
        icon: 'decoration' as const,
        title: 'Decorative Plaster for Businesses',
        description: 'Stucco veneziano and travertine effects for office lobbies, Blloku restaurants and central Tirana hotels.',
        features: ['Office lobbies', 'Blloku restaurants', 'Stucco veneziano', 'Urban modern style'],
      },
      {
        icon: 'insulation' as const,
        title: 'Urban Wall Renovations',
        description: 'Crack and moisture damage repairs in older Tirana buildings and apartment blocks. Restoration without structural intervention.',
        features: ['Older buildings', 'Moisture cracks', 'Facade restoration', 'Complete renovation'],
      },
    ],
    commercialCategories,
    benefits,
